...
> değil:** iki madde açık. Sınır bir okunabilirlik kuralı; onu delen şey
...
> birini, dilim 2b üçünü, dilim 3a üçünü, dilim 4, 5, 6 ve 7a birer tane
> kapattı; on altısı
> `resolved/to-frontend-2026-08.md`'ye taşındı ve dosya 496'dan 106'ya indi.
> Kalan ikisi aşağıda, ve ikisi de kapanış dilimi.
>
...
dilim 6'nın kapattığı `B-061` ve dilim 7a'nın kapattığı `B-058` — hepsi
