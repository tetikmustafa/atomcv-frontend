# Kapatılmış maddeler — frontend → backend · 2026-09
...
> tarafından yazılmış özgün hâli `git show d2172b1:docs/handoff/to-backend.md`
> içinde. Üçü de 2026-08-30'da gerçek uca karşı **ölçümden** çıktı ve
> 2026-09-02'de `ACK` edildi.
>
> **Frontend'in bu üçe karşılık yaptığı iş** (dilim 13, `notes/current.md`):
> `F-027` iki yerde duran "iki kez basılırsa `204`" iddiasını yanlışladı —
> uç yorumu ve mock yorumu düzeltildi, ikinci basışın `401`'i teste bağlandı.
> `F-025`'in kuralı mock'a girdi: işveren adı ilanda geçmiyorsa alan
> yazılmıyor, ve bununla mock ilk kez **şirketsiz ama rollü** satırı
